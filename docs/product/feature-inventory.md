...
1. **Implemented 2026-07-22 · Critical · M:** [Workspace backup discoverability](../technical/release-polish-workspace-backup-discoverability-spec.md)
   routes setup-transfer scope copy directly to the existing full Workspace
   backup owner without changing setup or Workspace envelopes.
...
[the backlog](../project/backlog.md#2026-07-22-release-polish-specifications).
