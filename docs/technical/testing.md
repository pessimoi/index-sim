...
the expanded default Playwright gate passes 56/56. The first focused run found
...
The latest functional and repository-local visual release-evidence checks were refreshed on 2026-07-10 for the source-backed Revision 274 root runtime. They do not choose production hosting, CSP implementation, live upstream providers, a canonical remote visual runner or deeper legacy migration.

| Check                                                       | Latest result                                                             | Notes and follow-up                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ----------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `npm run typecheck`                                         | `pass`                                                                    | 2026-07-10 D-059 refresh passed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `npm run test`                                              | `pass`                                                                    | 2026-07-10 full Vitest run passed across 30 files and 491 tests, including generated runtime, raw parser/generator, canonical economy and browser-local item trends, Planner/loadout requirements, shareable permalink contract/adapter behavior, Duel export/import, legacy Duel migration, the all-monster Duel matrix and its maximum-size CPU-time bound, the 18-case rewrite browser-fixture adapter, scheduled-price/generated-fallback composition, UI/view-model, persistence, migration, scheduled-market writer and performance coverage.                                                                                                                                                                                                                                                                                                                                                                            |
...
| `npm run test:e2e`                                          | `pass`                                                                    | The latest full 2026-07-10 production-preview gate passed 56/56 in Chromium against the source-backed Revision 274 runtime. It includes the on-demand Duel monster matrix, all 18 golden fixture setups through the visible metric strip, three shareable permalink review/Load/Undo/rejection workflows and the mobile Planner/MonsterCard non-overlap assertion. The initial all-fixture run exposed a scheduled-price fallback wiring mismatch; after composing generated item/alch fallbacks into the dynamic scheduled snapshot and updating evidence-backed GP expectations, the focused case, affected numeric rows and full gate pass.                                                                                                                                                                                                                                                                                 |
...
| Shareable setup focused checks                              | `unit and browser pass`                                                   | `npm run test -- src/tests/shareable-setup.test.ts src/tests/ui-adapters.test.ts` passed 59/59, and the three permalink production-preview tests are included in the full 56/56 gate. Evidence covers strict bounded parsing, duplicate keys, game-data mismatch/unknown ids/stale loot, root/sub-path URL handling, clipboard failure, review-before-write, Load/Dismiss, complete Undo and preservation of unrelated/local price state.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Repository-local visual regression                          | `pass on Darwin`                                                          | The current 56/56 functional smoke remains the workflow/numeric owner. The separate [visual regression suite](visual-regression-spec.md) passed 19/19 against 23 reviewed Darwin baselines with deterministic state and explicit update policy. Remote merge-blocking status and a canonical CI platform baseline still need a separate CI decision.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
passes 56/56 against the source-backed runtime. Older localhost `EPERM`, timeout
...
| ----------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------- |
| `matches browser-rendered dense numeric snapshots`                                                                | Dense / metric strip / Cannon output                       | No current failure in the latest successful gate.                                                                                                            | Covered by the expanded 53/53 Playwright pass and all-fixture source-backed metric comparison.                | none active                                        | Keep expectation changes tied to source-backed view-model or parity evidence. |
| `matches release-path dense numeric snapshots`                                                                    | Dense release path / metric strip                          | No current failure in the latest successful gate. Historical failure was a timeout before numeric assertions while setting up the large multi-scenario path. | Expanded 53/53 Playwright pass plus Goal 3 focused domain/view-model and golden pass.                         | historical `timing/flaky`                          | Do not treat the historical timeout as a numeric delta.                       |
| `matches browser-rendered numeric snapshots for loot action and trip overrides`                                   | Loot action override / Trip manual controls / metric strip | No current failure in the latest successful gate. Historical failure timed out while editing `Recoil rings`; no numeric mismatch was reported.               | Expanded 53/53 Playwright pass plus Goal 3 focused trip/loot, XP, UI view-model and golden pass.              | historical `timing/flaky`                          | Keep expectation changes tied to source-backed view-model or parity evidence. |
| `matches browser-rendered numeric snapshots for imported price sets`                                              | PriceSet import / money metrics                            | No current failure in the latest successful gate.                                                                                                            | Covered by the expanded 53/53 Playwright pass and `src/tests/data-economy.test.ts` in the Goal 3 focused run. | none active                                        | Live market upstream parity remains outside automated browser tests.          |
| `enables cannon for the selected monster and shows cannon rates` and Cannon numeric output inside dense snapshots | Cannon / Trip sparse link / metric strip                   | No current failure in the latest successful gate. Historical Cannon row was a tab actionability timeout after reload, not a numeric mismatch.                | Expanded 53/53 Playwright pass plus Goal 3 focused trip/loot, XP and UI view-model pass.                      | none active; related historical row `timing/flaky` | Keep current Cannon output expectations.                                      |
...
- browser-local price history snapshots only for accepted imported, compatible legacy or explicit Snapshot now captures, with scheduled restore and failed import paths leaving history unchanged
...
The Playwright scaffold includes mocked market status coverage plus the scheduled static JSON UI path. It checks Settings Price data scheduled snapshot counts, validated `PriceSet` import, selected active `PriceSet` persistence across reloads, active `PriceSet` export/reset controls, reset-to-scheduled fallback keeping local history, non-fatal failed PriceSet import recovery with validation code, schema-path diagnostics, unchanged active `PriceSet` and unchanged browser-local history, the Market price data scheduled-only copy, active `PriceSet` summary and local import path, the browser-local price history summary, Economy movers analysis, row sparklines, item trend selection/summary/chart/points, Snapshot now, confirmed Clear history, browser-rendered metric-strip numbers after imported `PriceSet` values are accepted and restored after reload, Result/Loot/Economy price-warning surfacing for imported price sets, and absence of stale production `/api/prices`, `/api/scrape` or `run_sim.py` instructions. Compatibility `/api/market/sync` adapter/server tests remain mocked; the visible production UI must not call a live market upstream or expose user-triggered refresh controls.
...
- browser-local Economy movers and item-trend analysis, Snapshot now and confirmed Clear history that removes only `index-sim:price-history`
