...
The current 2026-07-20 integration gate passes `npm run verify`: 107 Vitest
files / 1,040 tests, 19 explicit goldens, typecheck, the 161-source-module/
146-client-reachable-module/eight-external-entrypoint zero-cycle architecture
check, build/artifact budgets, lint, formatting and diff checks are green. The
23-file artifact has 16 JavaScript chunks and SHA-256
`737f35a736a2add0eb42a0554175631ec69165fdcfcd0d48ada3c34b81fde581`;
its direct entry is 776,137 raw / 228,359 gzip bytes and remains inside the
D-098-rebased D-094 budgets. The complete production-preview Chromium gate
passes 115/115 with one worker.
