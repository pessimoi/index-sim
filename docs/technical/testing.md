...
| `npm run test`                                              | `pass`                                                                    | 2026-07-11 full Vitest run passed across 34 files and 524 tests, including Duel setup-diff/shared-context exclusions, five Cloudflare Worker tests and the expanded artifact `_headers` contract test alongside the prior generated runtime, domain, UI, migration, market and Hiscores coverage.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
