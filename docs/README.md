...
- Cross-browser release support specification: [technical/cross-browser-release-support-spec.md](technical/cross-browser-release-support-spec.md)
...
- The Playwright Firefox/WebKit/mobile-WebKit manifest, real-Safari claim gate and browser exception policy belong in [technical/cross-browser-release-support-spec.md](technical/cross-browser-release-support-spec.md); the complete Chromium and Darwin visual owners remain unchanged.
